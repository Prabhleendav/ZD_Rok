	...
	return (
		<footer className="grid grid-cols-1 md:(grid-cols-3) border-t border-gray-300 bg-gray-200 px-4">
			<div className="m-4 sm:m-6 flex-1">
				<h2 className="text-4xl text-center md:text-left mb-4">ZD_ROK</h2>
				<p className="text-justify text-gray-700">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt dignissimos ratione cum modi dicta veniam obcaecati consequuntur. Officia voluptates amet nam vel sed, velit obcaecati. Fugiat molestias impedit officia adipisci!</p>
			...
			<div className="m-4 sm:m-6">
				...
				<ul className="space-y-3 text-gray-700">
					<li className="flex items-center">
						...
						<span>16/98 IE, G/F Ganesh Gali, Karol Bagh, New Delhi</span>
					</li>					
					<li className="flex items-center">
						<Phone className="w-5 h-5 mr-2" />
						<span>+91 9599774646</span>
					</li>					
					<li className="flex items-center">
						<Mail className="w-5 h-5 mr-2" />
						<a href="mailto:Zdrok.info@gmail.com" target="_blank">
							Zdrok.info@gmail.com
						</a>
					</li>
